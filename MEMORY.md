...
- Am I abstracting based on what the code IS (structure) or what the code MEANS (semantics)?
...
Interdimensional Terminal Forge is a modern web-based terminal platform designed for reliability, performance, and extensibility. It uses Rust for backend and PTY services, React/Vite for the frontend, and integrates the Claude CLI for advanced AI-powered coding assistance.

## Key Features

- Static file serving (React frontend via Rust backend)
- Real-time terminal (PTY sessions via WebSocket)
- API endpoints for command execution and health checks
- Claude CLI integration for AI-powered coding assistance
- Automated startup and dependency checks via `./start.sh`
...
3. Use in terminal:  
   - `claude`
   - `claude --file src/App.tsx "Explain this component"`
